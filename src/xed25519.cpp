...
void pybind(pybind11::module m) {
    ...
    m.def(
            ...
            [](py::bytes x25519_privkey, py::bytes msg) {
                auto a = bytes_from_pybytes(x25519_privkey, "x25519_privkey", 32);
                auto sig = sign(a, bytes_from_pybytes(msg));
    ...
    m.def(
            ...
            [](py::bytes x25519_pubkey) {
                auto A = bytes_from_pybytes(x25519_pubkey, "x25519_pubkey", 32);
                auto edpk = pubkey(A);
    ...
    m.def(
            ...
            [](py::bytes signature, py::bytes x25519_pubkey, py::bytes msg) {
                auto sig = bytes_from_pybytes(signature, "signature", 64);
                auto A = bytes_from_pybytes(x25519_pubkey, "x25519_pubkey", 32);
                return verify(sig, A, bytes_from_pybytes(msg));
            },
            "signature"_a,
            "x25519_pubkey"_a,
            "msg"_a,
